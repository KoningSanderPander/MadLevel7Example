package nl.svdoetelaar.madlevel7example.viewmodels
...
import nl.svdoetelaar.madlevel7example.repositories.QuizRepository
import java.util.*

class QuizViewModel(application: Application) : AndroidViewModel(application) {
    private val TAG = "FIRESTORE"
    private val quizRepository = QuizRepository(application.applicationContext)
